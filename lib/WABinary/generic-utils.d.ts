...
export declare const getBinaryFilteredButtons: (nodeContent: BinaryNode[]) => boolean;
export declare const getBinaryFilteredBizBot: (nodeContent: BinaryNode[]) => boolean;
